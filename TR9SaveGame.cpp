...
static const char *TR1LevelNames [] =
{
    ...
    "03: The Lost Valley",          // Shotgun
    "04: Tomb of Qualopec",         
    "05: St. Francis' Folly",       //  Magnum
    "06: Colosseum",                
    "07: Palace Midas",             
    "08: Cistern",
    "09: Tomb of Tihocan",
    ...
    "12: Sanctuary of the Scion",   //  Uzis
    "13: Natla's Mines",            
    "14: Atlantis",
    "15: The Great Pyramid",        // End if TR1

    "16: Return to Egypt",          // Start of TUB 
    "17: Temple of the Cat",        //  All Guns
    "28: Atlantean Stronghold",
    "19: The Hive",
    "20: ",
    "21: ",
    "22: ",
...
{
    "01: Great Wall",               //  Grenade

    "02: Venice",                   //  Magnum
    "03: Bartoli's Hideout",        //  Uzi
    "04: Opera House",

    "05: Offshore Rig",             // Shotgun Harpoon
    "06: Diving Area",              //  M16
    "07: 40 Fathoms",
    ...
    "19: The Cold War",         //  Harpoon M16 Magnum Uzi
    "20: Fool's Gold",          //  Grenade
...
static const char *TR3LevelNames [] =
{
    ...
    "02: Temple Ruins",
    "03: The River Ganges",
    "04: Caves of Kaliya",          // Grenade

    //  
    //  South Pacific
    "05: Coastal Village",          // Harpoon
    "06: Crash Site",               // M16
    "07: Madubu Gorge",             // Rocket
    "08: Temple of Puna",           // Magnum

    //  London
    "09: Thames Wharf",
    "10: Aldwych",                  //  Uzi M16 Rocket
    "11: Lud's Gate",               //  Rocket Harpoon
    "12: City",

    //  Nevada
    "13: Nevada Desert",            // Nevada
    "14: High Security Compound",   // Magnum Grenade
    "15: Area 51",                  // M16 Grenade

    //  Antartica
    "16: Antarctica",               //  Uzi
    "17: RX-Tech Mines",
    "18: Lost City of Tinnos",      //  Rocket
    "19: Meteorite Cavern",

    //
    "20: London - All Hallows",     //  Uzi
                                            ...
                                            bool allowZero, bool noGuns )
{
    ...
    if ( ( mask & TR1_MASK_MAGNUM ) == 0 )
    {
        magnumZero = 0;
    }

    if ( ( mask & TR1_MASK_UZI ) == 0 )
    {
        uziZero = 0;
    }

    if ( ( mask & TR1_MASK_RIOT ) == 0 )
    {
        riotZero = 0;
    }
                                            ...
                                            bool allowZero, bool noGuns  )
{
    ...
    //
    if ( ( mask & TR2_MASK_MAGNUM ) == 0 )
    {
        magnumZero = 0;
    }

    if ( ( mask & TR2_MASK_UZI ) == 0 )
    {
        uziZero = 0;
    }

    if ( ( mask & TR2_MASK_RIOT ) == 0 )
    {
        riotZero = 0;
    }

    if ( ( mask & TR2_MASK_M16 ) == 0 )
    {
        m16Zero = 0;
    }

    if ( ( mask & TR2_MASK_GRENADE ) == 0 )
    {
        grenadeZero = 0;
    }

    if ( ( mask & TR2_MASK_HARPOON ) == 0 )
    {
        harpoonZero = 0;
    }
                                            ...
                                            bool allowZero, bool noGuns  )
{
    ...
    //
    if ( ( mask & TR3_MASK_MAGNUM ) == 0 )
    {
        magnumZero = 0;
    }

    if ( ( mask & TR3_MASK_UZI ) == 0 )
    {
        uziZero = 0;
    }

    if ( ( mask & TR3_MASK_RIOT ) == 0 )
    {
        riotZero = 0;
    }

    if ( ( mask & TR3_MASK_M16 ) == 0 )
    {
        m16Zero = 0;
    }

    if ( ( mask & TR3_MASK_GRENADE ) == 0 )
    {
        grenadeZero = 0;
    }

    if ( ( mask & TR3_MASK_HARPOON ) == 0 )
    {
        harpoonZero = 0;
    }

    if ( ( mask & TR3_MASK_ROCKET ) == 0 )
    {
        rocketZero = 0;
    }
...
void *CTR9SaveGame::GetBlockSlot ( int tombraider, int block, int slot )
{
    ...
    switch ( tombraider )
    {
        case 1 : return  m_TR1_Blocks [ block ][ slot ];
        case 2 : return  m_TR2_Blocks [ block ][ slot ];
        case 3 : return  m_TR3_Blocks [ block ][ slot ];
    }
    return NULL;
}
...
void *CTR9SaveGame::GetBlockGuns ( int tombraider, int block, int slot )
{
    ...
    switch ( tombraider )
    {
        case 1 : return  m_TR1_Guns [ block ][ slot ];
        case 2 : return  m_TR2_Guns [ block ][ slot ];
        case 3 : return  m_TR3_Guns [ block ][ slot ];
    }
    return NULL;
}
...
int CTR9SaveGame::GetBlockLength ( int tombraider )
{
    switch ( tombraider )
    {
        case 1 : return TR1_BLOCK_LENGTH;
        case 2 : return TR2_BLOCK_LENGTH;
        case 3 : return TR3_BLOCK_LENGTH;
    }
    return 0;
}
...
int CTR9SaveGame::GetLevelCount ( int tombraider )
{
    switch ( tombraider )
    {
        case 1: return sizeof(TR1Secrets);
        case 2: return sizeof(TR2Secrets);
        case 3: return sizeof(TR3Secrets);
    }
    ...
    switch ( tombraider )
    {
        ...
        case 1:
        {
            ...
            if ( pBlock != NULL )
            {
                ...
                {
                    pBlock->gunmask     |= TR1_MASK_GUN;    // Pistol
                }
                else
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR1_MASK_GUN ^ 0xff );
                }
            }
            break;
        }
        ...
        case 2:
        {
            ...
            if ( pBlock != NULL )
            {
                ...
                if ( bAuthorized && bEnabled )
                {
                    pBlock->gunmask     |= TR2_MASK_GUN;    // Pistol
                }
                else
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_GUN ^ 0xff );
                }
            }
            break;
        }
        ...
        case 3:
        {
            ...
            if ( pBlock != NULL )
            {
                ...
                if ( bAuthorized && bEnabled )
                {
                    pBlock->gunmask     |= TR3_MASK_GUN;    // Pistol
                }
                else
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_GUN ^ 0xffff );
                }
            }
            break;
        }
    ...
    switch ( tombraider )
    {
        ...
        case 1:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR1_MASK_MAGNUM; // Magnum
                    pBlock->magnum      = ammos;
                }
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR1_MASK_MAGNUM ^ 0xff );
                }
        ...
        case 2:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR2_MASK_MAGNUM; // Magnum
                    pBlock->magnum      = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_MAGNUM ^ 0xff );
                }
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR3_MASK_MAGNUM; // Magnum
                    pBlock->magnum      = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_MAGNUM ^ 0xffff );
                }
    ...
    switch ( tombraider )
    {
        ...
        case 1:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR1_MASK_UZI;    // Uzi
                    pBlock->uzi         = ammos;
                }
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR1_MASK_UZI ^ 0xff );
                }
        ...
        case 2:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR2_MASK_UZI;    // Uzi
                    pBlock->uzi         = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_UZI ^ 0xff );
                }
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR3_MASK_UZI;    // Uzi
                    pBlock->uzi         = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_UZI ^ 0xffff );
                }
    ...
    switch ( tombraider )
    {
        ...
        case 1:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR1_MASK_RIOT;   // riotgun
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR1_MASK_RIOT ^ 0xff );
                }
        ...
        case 2:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR2_MASK_RIOT;   // riotgun
                    pBlock->riotgun     = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_RIOT ^ 0xff );
                }
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR3_MASK_RIOT;   // riotgun
                    pBlock->riotgun     = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_RIOT ^ 0xffff );
                }
    ...
    switch ( tombraider )
    {
        ...
        case 2:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR2_MASK_HARPOON;    // harpoon
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_HARPOON ^ 0xff );
                }
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR3_MASK_HARPOON;    // harpoon
                    pBlock->harpoon     = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_HARPOON ^ 0xffff );
                }
    ...
    switch ( tombraider )
    {
        ...
        case 2:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR2_MASK_M16;    // m16
                    pBlock->m16         = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_M16 ^ 0xff );
                }
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR3_MASK_M16;    // m16
                    pBlock->m16         = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_M16 ^ 0xffff );
                }
    ...
    switch ( tombraider )
    {
        ...
        case 2:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR2_MASK_GRENADE;    // grenade
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR2_MASK_GRENADE ^ 0xff );
                }
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock )
                {
                    pBlock->gunmask     |= TR3_MASK_GRENADE;    // grenade
                    pBlock->grenade     = ammos;
                }
                if ( pGun )
                {
            ...
            else
            {
                if ( pBlock )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_GRENADE ^ 0xffff );
                }
    ...
    switch ( tombraider )
    {
        ...
        case 3:
        {
            ...
            if ( bAuthorized && bEnabled )
            {
                if ( pBlock != NULL )
                {
                    pBlock->gunmask     |= TR3_MASK_ROCKET; // rocket
                    pBlock->rocket      = ammos;
                }
            ...
            else
            {
                if ( pBlock != NULL )
                {
                    pBlock->gunmask     = pBlock->gunmask & ( TR3_MASK_ROCKET ^ 0xffff );
                }
