...
//  BLOCK_OFFSET is 0x40, 0x40 and 0xA4
//  For example if in Info the address is 0x800 we can set address to 0x840
#define ADDRESS_20_100(v)   (v+0x20),(v+0x100)

TR_HEALTH_RANGE TR1_HEALTH_RANGES[32] =
{
    { 0x800+0x20,   0x800+0x100,    },  // Caves
    { 0x196C+0x20,  0x196C+0x100,   },  // City of Vilacamba
    { 0x808+0x20,   0x808+0x100,    },  // Lost Valley
    { 0xCA4+0x20,   0xCA4+0x100,    },  // Tomb of Qualopec
    { 0x1BB4+0x20,  0x1BB4+0x100,   },  // St. Francis' Folly
    { 0x100A+0x20,  0x100A+0x100,   },  // Colosseum
    { 0X80A+0x20,   0X80A+0x100,    },  // Palace Midas
    { 0x1B12+0x20,  0x1B12+0x100,   },  // The Cistern
    { 0xA40+0x20,   0xA40+0x200,    },  // Tomb of Tihocan
    { 0x802+0x20,   0x802+0x100,    },  // City of Khamoon
    { 0xACA+0x20,   0xACA+0x100,    },  // Obelisk of Khamoon
    { 0x1246+0x20,  0x1246+0x100,   },  // Sanctuary of the Scion
    { 0x1348+0x20,  0x1348+0x100,   },  // Natla's Mines
    { 0xD82+0x20,   0xD82+0x100,    },  // Atlantis
    { 0x1234+0x20,  0x1234+0x100,   },  // The Great Pyramid
    { 0x8EE+0x20,   0x8EE+0x100,    },  // Return to Egypt
    { 0xEAC+0x20,   0xEAC+0x100,    },  // Temple of the Cat
    { 0xEBC+0x20,   0xEBC+0x100,    },  // Atlantean Stronghold
    { 0x11C2+0x20,  0x11C2+0x100,   },  // The Hive
    { 0, 0 },
    { 0, 0 },
    { 0, 0 },
    { 0, 0 },
...
{
    {   0xB56+0x20,     0xB56+0x100,    },  // The Great Wall
    {   0x7DC+0x20,     0x7DC+0x100,    },  // Venice
    {   0x1782+0x20,    0x1782+0x100,   },  // Bartoli's Hideout
    {   0x1E90+0x20,    0x1E90+0x100,   },  // Opera House
    {   0xAF6+0x20,     0xAF6+0x100,    },  // Offshore Rig
    {   0x12A4+0x20,    0x12A4+0x100,   },  // Diving Area
    {   0x7DE+0x20,     0x7DE+0x100,    },  // 40 Fathoms
    {   0x23DE+0x20,    0x23DE+0x100,   },  // Wreck of the Maria Doria
    {   0x90C+0x20,     0x90C+0x100,    },  // Living Quarters
    {   0xB82+0x20,     0xB82+0x100,    },  // The Deck
    {   0x139A+0x20,    0x139A+0x100,   },  // Tibetan Foothills
    {   0x2530+0x20,    0x2530+0x100,   },  // Barkhang Monastery
    {   0x7DA+0x20,     0x7DA+0x100,    },  // Catacombs of the Talion
    {   0xEF4+0x20,     0xEF4+0x100,    },  // Ice Palace
    {   0x2BBE+0x20,    0x2BBE+0x100,   },  // Temple of Xian
    {   0x9D6+0x20,     0x9D6+0x100,    },  // Floating Islands
    {   0x1002+0x20,    0x1002+0x100,   },  // The Dragon's Lair
    {   0xF50+0x20,     0xF50+0x100,    },  // Home Sweet Home
    {   0x16F8+0x20,    0x16F8+0x100,   },  // The Cold War
    {   0x1F3E+0x20,    0x1F3E+0x100,   },  // Fool's Gold
    {   0x21BE+0x20,    0x21BE+0x100,   },  // Furnace of the Gods
    {   0x918+0x20,     0x918+0x100,    },  // Kingdom
    {   0xE54+0x20,     0xE54+0x100,    },  // Nightmare in Vegas
    //
    { 0, 0 },
    { 0, 0 },
    { 0, 0 },
...
//  Add Start of Block
#define ADDRESS_80_100(v)   (v+0x80),(v+0x100)
TR_HEALTH_RANGE TR3_HEALTH_RANGES [32] =
{
    {   0xAA6+0x80,  0xAA6+0x100,    },  // Jungle
    {   0xD96+0x80,  0xD96+0x100,    },  // Temple Ruins
    {   0xA70+0x80,  0xA70+0x100,    },  // The River Ganges
    {   0x100C+0x80, 0x100C+0x100,   },  // Caves of Kaliya
    {   0xC60+0x80,  0xC60+0x100,    },  // Coastal Village
    {   0x21FE+0x80, 0x21FE+0x100,   },  // Crash Site
    {   0x1284+0x80, 0x1284+0x100,   },  // Madubu Gorge
    {   0xA46+0x80,  0xA46+0x100,    },  // Temple of Puna
    {   0x10E2+0x80, 0x10E2+0x100,   },  // Thames Wharf
    {   0x2FD2+0x80, 0x2FD2+0x100,   },  // Aldwych
    {   0x100E+0x80, 0x100E+0x100,   },  // Lud's Gate
    {   0xB42+0x80,  0xB42+0x100,    },  // City
    {   0xA6C+0x80,  0xA6C+0x100,    },  // Nevada Desert
    {   0xACC+0x80,  0xACC+0x100,    },  // High Security Compound
    {   0x1230+0x80, 0x1230+0x100,   },  // Area 51
    {   0xA8A+0x80,  0xA8A+0x100,    },  // Antarctica
    {   0xFB4+0x80,  0xFB4+0x100,    },  // RX-Tech Mines
    {   0xB04+0x80,  0xB04+0x100,    },  // Lost City of Tinnos
    {   0xA94+0x80,  0xA94+0x100,    },  // Meteorite Cavern
    {   0x1092+0x80, 0x1092+0x100,   },  // All Hallows
    {   0x1D4C+0x80, 0x1D4C+0x100,   },  // Highland Fling
    {   0x168A+0x80, 0x168A+0x100,   },  // Willard's Lair
    {   0x13EC+0x80, 0x13EC+0x100,   },  // Shakespeare Cliff
    {   0xAD6+0x80,  0xAD6+0x100,    },  // Sleeping with the Fishes
    {   0x108C+0x80, 0x108C+0x100,   },  // It's a Madhouse!
    {   0x1786+0x80, 0x1786+0x100,   },  // Reunion
    //
    { 0, 0 },
    { 0, 0 },
    { 0, 0 },
...
//
/////////////////////////////////////////////////////////////////////////////
DWORD CTR9SaveGame::GetOutfits ( )
{
    DWORD current   = 0;
#if TR123_PATCHED
    current = * ( DWORD * ) ( m_pBuffer + OUTFITS_BASE_OFFSET );
#endif
    return current;
}
...
//
/////////////////////////////////////////////////////////////////////////////
void CTR9SaveGame::SetOutfits ( DWORD value )
{
#if TR123_PATCHED
    if ( value )
    {
        //  Change only once
        DWORD current = * ( DWORD * ) ( m_pBuffer + OUTFITS_BASE_OFFSET );
        if ( current != OUTFITS_BASE_ALL )
        {
            * ( DWORD * ) ( m_pBuffer + OUTFITS_BASE_OFFSET )   = OUTFITS_BASE_ALL;
            * ( DWORD * ) ( m_pBuffer + OUTFITS_DISP_OFFSET )   = OUTFITS_BASE_ALL;
        }
    }
    else
    {
        * ( DWORD * ) ( m_pBuffer + OUTFITS_BASE_OFFSET )   = 0x0;
        * ( DWORD * ) ( m_pBuffer + OUTFITS_DISP_OFFSET )   = 0x0;
    }
#endif
}
