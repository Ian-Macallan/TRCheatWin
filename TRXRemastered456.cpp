...
BOOL CTRXRemastered456::OnInitDialog()
{
    ...
    if ( m_bToolTip )
    {
        ...
        m_ToolTip.AddTool( &m_Real_Health, "For TR4 0 means full health");
...
BOOL CTRXRemastered456::OnSetActive()
{
    ...
    if ( m_pListCtrl == NULL )
    {
        ...
        strcat_s ( szDefault, sizeof(szDefault), "\\AppData\\Roaming\\TRX2\\" );
        strcat_s ( szDefault, sizeof(szDefault), CTRXGlobal::m_szTRX2Number );
