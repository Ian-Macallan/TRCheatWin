...
/////////////////////////////////////////////////////////////////////////////
HBRUSH CTRXTools::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL CTRXTools::OnEraseBkgnd(CDC* pDC, CWnd* pWnd)
{
    if ( CTRXGlobal::m_iDarkTheme == 0 )
    {
        return FALSE;
...
//
/////////////////////////////////////////////////////////////////////////////
COLORREF CTRXTools::GetTextColor()
{
    if ( CTRXGlobal::m_iDarkTheme == 0 )
    {
        return FALSE;
